...
let texto =
    ["Se destaca como el principal enclave arqueológico maya gracias a su ingenioso trazado urbano, la majestuosidad de sus estructuras y la meticulosa labor en piedra de sus edificaciones. <br><br>En su diseño se aprovechó de manera notable la geografía de la colina que lo convirtió en un impresionante centro ceremonial.",
        ...
        "Las pirámides de Giza en Egipto han sido galardonadas con los premios 'Oscar' del turismo. Consideradas como la 'principal atracción turística mundial' por los World Travel Awards (WTA), estos premios, otorgados anualmente por las agencias de viajes, son conocidos como los Oscar del turismo.",
        "Aunque a menudo se le considera un templo, el Taj Mahal es en realidad un mausoleo que encierra una hermosa y trágica historia de amor entre un emperador y su esposa. Esta magnífica estructura fue erigida en el siglo XVII y se encuentra en las proximidades de la ciudad de Agra, en el estado de Uttar Pradesh, en la India. Es, sin lugar a dudas, una parada obligatoria para los miles de turistas que visitan esta región de la India. Pero ahora, adentrémonos en la apasionante historia de amor que envuelve este mágico sitio.",
        "Se erige como el edificio más alto de París y uno de los destinos más populares tanto en la ciudad como en el mundo entero: la Torre Eiffel, con sus imponentes 324 metros de altura, atrae a una media de 7 millones de visitantes durante todo el año. Cada noche, este emblemático símbolo de París se engalana con una iluminación dorada y el mágico destello que lo envuelve durante cinco minutos al comienzo de cada hora hasta la 1 de la madrugada.",
        "Cada año, aproximadamente 3,5 millones de personas visitan La Alhambra, un monumento de incomparable belleza que ostenta el título del más visitado de España y uno de los más impresionantes del mundo. Este complejo de palacios, jardines y fortalezas fue iniciado por órdenes de los monarcas nazaríes del Reino de Granada en 1377, y sus numerosos rincones cautivadores justifican dedicarle una jornada completa de visita.",
        "En nuestra lista de los destinos más populares del mundo, no podía faltar uno de los grandes de Italia: el Coliseo. Construido en el siglo I en el corazón de Roma, este antiguo anfiteatro recibe cada año a más de 5 millones de visitantes. Con juegos de gladiadores, batallas navales y luchas con animales, el Coliseo, también conocido como el Anfiteatro Flavio, fue parte integral del entretenimiento público en la antigua Roma, quizás su nombre proviene de la colosal estatua de Nerón que se alzaba cerca.",
        "Times Square, la emblemática plaza situada en el corazón de Nueva York, se ha convertido a lo largo de los años en un verdadero símbolo de esta ciudad cosmopolita, gracias a sus deslumbrantes luces y sus llamativos carteles publicitarios. Con miles de luces y enormes pantallas publicitarias, Times Square se ha consolidado como el icono más reconocible de Nueva York. En el centro de esta bulliciosa zona se encuentra la plaza, ubicada en la intersección de Broadway y la 7ª Avenida."];
